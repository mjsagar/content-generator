      ...
      <div className="mb-12 text-center">
        <div className="flex items-center justify-center mb-6">
          <a
            ...
            className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold border transition-all hover:opacity-85 shadow-xs ${catMeta.badgeBg} ${catMeta.badgeText} ${catMeta.border}`}
          >
